...
// y=Number(y);
// // we need a loop to count the number of iterations 6 times
// // we need a loop to check the answer with the array
// for (var index = 0; index < 5; index++) {
//     console.log(index);
//     y = prompt(" guess an odd  number between  1 to 30 that i put in my array");
//     for (let j = 0; j < arr.length; j++) {
//         //compair the input with my array
//         //if i find it i will end the loop  and end the outer loop
//         console.log(j);
//         if (y == arr[j]) {
...
//         }
//         else {
//             y = prompt(" guess an odd  number berteen 1 to 30 that i put in my array");
